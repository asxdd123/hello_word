package com.itheima.springbppt.fastdfs;
...
//            .getContextClassLoader().getResource("").getPath() + "fastdfs-client.conf";

    private static  final String CONF_FILENAME = new ClassPathResource("fastdfs-client.conf")
                                                    .getPath();
